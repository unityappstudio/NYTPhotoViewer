...
- (instancetype)initWithCoder:(NSCoder*)aDecoder {
    @throw [NSException exceptionWithName:@"NYTScalingImageView" reason:@"Must initWithFrame: instead." userInfo:nil];
...
- (void)updateImage:(UIImage*)image {
    ...
    if (minScale > 1) {
        self.imageView.frame = CGRectMake(0, 0, image.size.width * minScale, image.size.height * minScale);
    } else {
